/obj/item/gun/projectile/rebar
	...
	desc = "A GP heavy pistol that could punch a whole into several layers of plasteel. Uses 12.7mm rounds. Also has the ablity to have a Master Unmaker integrated into it."
