/obj/item/gun/projectile/trouble_shooter
	...
	Its material cost lead to it being mainly used in-house rather than in mass production. Has the ablity to have a Master Unmaker integrated into it."
