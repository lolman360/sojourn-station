...
/obj/item/part/gun/frame/slideshot
	...
	desc = "A homemade slide shotgun frame. Cobbled together from scrap metal and wood, it can take either shotgun or 12.7mm cheap barrels."
	...
	barrelvars = list(/obj/item/part/gun/barrel/shotgun/steel, /obj/item/part/gun/barrel/kurtz/steel)	//shotgun or 12.7mm.
