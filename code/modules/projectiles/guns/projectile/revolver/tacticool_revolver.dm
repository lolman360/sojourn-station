/obj/item/gun/projectile/revolver/tacticool_revolver
	...
	desc = "When people complained that other 12.7mm revolvers were impractical due to its wrist snapping recoil, Scarborough Arms decided what it really needed was a tactical scope for sniping. Uses 12.7mm."
