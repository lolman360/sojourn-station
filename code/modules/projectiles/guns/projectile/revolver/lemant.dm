...
/obj/item/gun/projectile/revolver/lemant/uppercut
	...
	desc = "Once a legendary frontier weapon on old earth, hailing from its second greatest empire, this signature weapon holds six 12.7mm rounds and one single action underslung 20mm shell. \
	This particular model is crafted by the New Testament, having good utility and plenty of shots, but is painstaking to reload since it requires removing each spent shell individually. \
	This model is a conversion, known as the pilgrim hero, its caliber is converted to 12.7mm but it loses ammo capacity due to the larger shells and lacks the \
	...
	caliber = CAL_50
	fire_sound = 'sound/weapons/guns/fire/12.7mm_revolver.ogg'
